...
6. 在参考文献之前生成或核验 2026 版“AI 工具使用声明”。已使用 AI 时，支撑材料必须含文件名完全一致的 `AI 工具使用详情.pdf`，并从 `AI_USAGE.md` 回读名称/版本或型号、用途环节、提示与过程、采纳/人工修改/核验；同时核对核心建模与分析的队员主导证据。未使用声明必须与过程档案一致。
