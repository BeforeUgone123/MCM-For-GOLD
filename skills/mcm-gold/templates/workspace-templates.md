...
使用 AI 时从第一次交互起维护，赛末导出为支撑材料中的《AI工具使用详情》PDF；未使用时不建本文件，并在论文参考文献后写官方声明。

```markdown
# AI 工具使用详情
工具=<名称/版本/开发机构/日期>｜用途与环节=<...>｜是否涉及核心建模=<如实填>｜采纳及人工修改=<...>
关键交互 <ISO8601>：重要提示词=<原文或完整要点>｜回复=<原文或完整要点>｜采纳/修改=<...>｜对应 D/R-id=<...>
```
